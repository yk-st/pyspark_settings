...
RUN tar -xzvf spark-3.2.2-bin-hadoop3.2.tgz
...
RUN sudo ln -s spark-3.2.2-bin-hadoop3.2 spark
...
RUN wget https://dlcdn.apache.org/kafka/3.0.1/kafka_2.13-3.0.2.tgz

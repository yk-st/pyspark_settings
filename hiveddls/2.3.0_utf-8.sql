...
CREATE TABLE IF NOT EXISTS `BUCKETING_COLS` (
  ...
  `BUCKET_COL_NAME` varchar(256) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `COLUMNS_V2` (
  ...
  `COLUMN_NAME` varchar(767) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `DB_PRIVS` (
  ...
  `DB_PRIV` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `PART_COL_PRIVS` (
  ...
  `COLUMN_NAME` varchar(767) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `CREATE_TIME` int(11) NOT NULL,
  `GRANT_OPTION` smallint(6) NOT NULL,
  `GRANTOR` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `GRANTOR_TYPE` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  ...
  `PRINCIPAL_NAME` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `PRINCIPAL_TYPE` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `PART_COL_PRIV` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `PART_PRIVS` (
  ...
  `PRINCIPAL_NAME` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `PRINCIPAL_TYPE` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `PART_PRIV` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `SD_PARAMS` (
  `SD_ID` bigint(20) NOT NULL,
  `PARAM_KEY` varchar(256) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `PARAM_VALUE` MEDIUMTEXT CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `SKEWED_COL_NAMES` (
  `SD_ID` bigint(20) NOT NULL,
  `SKEWED_COL_NAME` varchar(256) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
  PRIMARY KEY (`SD_ID`,`INTEGER_IDX`),
...
CREATE TABLE IF NOT EXISTS `SKEWED_STRING_LIST_VALUES` (
  `STRING_LIST_ID` bigint(20) NOT NULL,
  `STRING_LIST_VALUE` varchar(256) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `IDXS` (
  ...
  `INDEX_HANDLER_CLASS` varchar(4000) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `INDEX_NAME` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `NUCLEUS_TABLES` (
  ...
  `OWNER` varchar(2) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `VERSION` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `INTERFACE_NAME` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `PARTITION_EVENTS` (
  ...
  `PARTITION_NAME` varchar(767) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `TBL_NAME` varchar(256) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `PARTITION_KEY_VALS` (
  `PART_ID` bigint(20) NOT NULL,
  `PART_KEY_VAL` varchar(256) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `TBL_COL_PRIVS` (
  ...
  `PRINCIPAL_NAME` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `PRINCIPAL_TYPE` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `TBL_COL_PRIV` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `TBL_ID` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `TBL_PRIVS` (
  ...
  `PRINCIPAL_NAME` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `PRINCIPAL_TYPE` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `TBL_PRIV` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `TBL_ID` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `TAB_COL_STATS` (
 ...
 `TABLE_NAME` varchar(256) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
 `COLUMN_NAME` varchar(767) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
 ...
 `BIG_DECIMAL_LOW_VALUE` varchar(4000) CHARACTER SET utf8 COLLATE utf8_bin,
 `BIG_DECIMAL_HIGH_VALUE` varchar(4000) CHARACTER SET utf8 COLLATE utf8_bin,
...
CREATE TABLE IF NOT EXISTS `TYPES` (
  ...
  `TYPE_NAME` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `TYPE1` varchar(767) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `TYPE2` varchar(767) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `TYPE_FIELDS` (
  ...
  `FIELD_TYPE` varchar(767) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `FUNCS` (
  ...
  `CLASS_NAME` VARCHAR(4000) CHARACTER SET utf8 COLLATE utf8_bin,
  `CREATE_TIME` INT(11) NOT NULL,
  `DB_ID` BIGINT(20),
  `FUNC_NAME` VARCHAR(128) CHARACTER SET utf8 COLLATE utf8_bin,
  `FUNC_TYPE` INT(11) NOT NULL,
  `OWNER_NAME` VARCHAR(128) CHARACTER SET utf8 COLLATE utf8_bin,
  `OWNER_TYPE` VARCHAR(10) CHARACTER SET utf8 COLLATE utf8_bin,
  PRIMARY KEY (`FUNC_ID`),
...
CREATE TABLE IF NOT EXISTS `FUNC_RU` (
  ...
  `RESOURCE_URI` VARCHAR(4000) CHARACTER SET utf8 COLLATE utf8_bin,
  `INTEGER_IDX` INT(11) NOT NULL,
